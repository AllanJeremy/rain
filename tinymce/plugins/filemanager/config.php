...
//$base_url="http://127.0.0.1//blog//public//"; //url base of site if you want only relative url leave empty
$upload_dir = '/black-val/public/tinymce/blog_media/'; // path from base_url to upload base dir
$current_path = '/../../blog_media/'; // relative path from filemanager folder to upload files folder
