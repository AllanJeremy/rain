...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<!--
		<input type="" id="popup" value="<?php //echo $popup; ?>" />
		<input type="" id="track" value="<?php //echo $_GET['editor']; ?>" />
		<input type="" id="cur_dir" value="<?php //echo $cur_dir; ?>" />
		<input type="" id="cur_dir_thumb" value="<?php //echo $thumbs_path.$subdir; ?>" />
		<input type="" id="root" value="<?php //echo $root; ?>" />
		<input type="" id="insert_folder_name" value="<?php //echo lang_Insert_Folder_Name; ?>" />
		<input type="" id="new_folder" value="<?php //echo lang_New_Folder; ?>" />
